...
The test runs the full P-Q area estimation algorithm (Q sweep + P sweep) for each unit combination 1, 2, ..., N_units_max.
Units are added one at a time in the order they appear in flex_unit_10.txt:
  g1, g1+g2, g1+g2+g3, ..., g1+...+g12

Only OPFs that converge (LOCALLY_SOLVED) contribute to the timing statistics.
...
Final timing results are saved to results/scalability_tests/scalability_num_units.csv.
